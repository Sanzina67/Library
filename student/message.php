     	...
     	<div class="msg">
             ...
             <br><div class="chat user">
             	<div style="float:left;padding-top:5px">
             		&nbsp
             		<?php
                      echo "<img class='img-circle profile_img' height=40 width=40 padding=5px src='images/".$_SESSION['pic']." '>";
             ...
             <br><div class="chat admin">
             	<div style="float:left;padding-top:5px">
             		&nbsp
             		<img class='img-circle profile_img' style="height:40px; width:40px; padding:5px" src="images/p.jpg">
             		&nbsp
             	</div>
             	<div style="float:left" class="chatbox">
             		<?php
       ...
       ?>
     	...
     	<div style="height:100px;padding-top:10px">
     		<form action="" method="post">
     			...
     			<button type="submit" name="submit" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-send"></span>&nbsp Send</button>
     		</form>
     	</div>
