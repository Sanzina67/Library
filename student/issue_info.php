...
<div class="container">
	...
	if(isset($_SESSION['login_user']))
	{
	   $sql="SELECT user_reg.username,user_id,books.bid,name,authors,edition,issue_date,return_date from user_reg inner join issue_book ON user_reg.username=issue_book.username inner join books ON books.bid=issue_book.bid WHERE issue_book.approve='YES' and issue_book.username='$_SESSION[login_user]' ORDER BY `issue_book`.`return_date` ASC  ";
