...
if(isset($_SESSION['login_user']))
{
  ...
  <br><br>
  <?php
  $sql="SELECT user_reg.username,user_id,books.bid,name,authors,edition,status from user_reg inner join issue_book ON user_reg.username=issue_book.username inner join books ON books.bid=issue_book.bid WHERE issue_book.approve=''";
  $res=mysqli_query($db,$sql);
   if(mysqli_num_rows($res)==0)
      {
        echo "<h1 style='color:white;margin:auto 400px'><b>";
...
else
{
  ?>
  <br><br> <br>
   <h2 style="text-align:center;color:yellow">You need to login first</h2>
  <?php
}
