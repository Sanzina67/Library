                            ...
                            <div class="box1">
                                   ...
                                   <form  action="" method="post">
                                      ...
                                      <div class="login">
                                          ...
                                          <input style="margin:auto 90px;color:green; height:25px;width:100px;" type="submit" name="submit"value="Login">
                                      </div> 
                                   </form>
                                   <p style="color:white; padding-left: 20px;">
                                          <br><br>
                                          <a style="color:yellow;" href="admin_update_password.php">Forgot Password?</a> &nbsp &nbsp &nbsp
                                          New to this website?<a style="color:yellow;" href="admin_reg.php">sign Up</a>
                                   </p>
                            </div>
                     </div>
              </section>
